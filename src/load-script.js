...
const removeEventListeners = function(targetType) {
  _listeners.forEach(({target, type, listener}) => {
...
const removeAllEventListeners = function() {
  _listeners.forEach(({target, type, listener}) => this.removeEventListener(type, listener));
};
window.removeAllEventListeners = removeAllEventListeners;
window.removeEventListeners = removeEventListeners;
document.removeEventListeners = removeEventListeners;
